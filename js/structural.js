/**
 * Structural Materials Category Page
 * Uses API endpoint instead of direct Firestore queries
 */

console.log('🔄 structural.js module loaded');

import { initializeApp } from "https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";
import { getAuth, onAuthStateChanged } from "https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";

const CATEGORY = 'Structural Materials';
let products = [];
...
console.log('✅ structural.js module execution complete');
